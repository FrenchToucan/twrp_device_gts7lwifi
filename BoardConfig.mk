...
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x00008000 --ramdisk_offset 0x02000000 --tags_offset 0x01e00000 --header_version 2 --board SRPTC18C001
...
BOARD_SUPER_PARTITION_SIZE := 7969034880
...
BOARD_GOOGLE_DYNAMIC_PARTITIONS_SIZE := 3980323136

# Set error limit to BOARD_SUPER_PARTITION_SIZE - 500MB
BOARD_SUPER_PARTITION_ERROR_LIMIT := 7444746880
